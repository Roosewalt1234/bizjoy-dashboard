...
BEGIN
  FOREACH t IN ARRAY ARRAY[
    'service_categories','contract_line_items','contract_assets','ppm_schedules','ppm_visits',
    'contract_manpower_plans','contract_manpower_assignments','attendance_logs','sla_policies','sla_events',
    'reporting_periods','weekly_reports','monthly_reports','invoice_packs','invoice_pack_items'
  ] LOOP
...
BEGIN
  FOREACH t IN ARRAY ARRAY[
    'service_categories','sla_policies','contract_line_items','contract_assets','ppm_schedules','ppm_visits',
    'contract_manpower_plans','contract_manpower_assignments','attendance_logs','reporting_periods',
    'weekly_reports','monthly_reports','invoice_packs'
  ] LOOP
