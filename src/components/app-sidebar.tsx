...
const items: NavItem[] = [
  ...
  { title: "Accounts", url: "/accounts", icon: Wallet, module: "accounts" },
  {
    ...
    module: "contracts",
    children: [
      { title: "AMC Contracts", url: "/contracts", module: "contracts" },
      { title: "AMC Work Orders", url: "/work-orders", module: "service" },
      { title: "AMC Work Completion Reports", url: "/service", module: "service" },
    ],
  },
  {
    title: "FM Projects",
    ...
    module: "projects",
    children: [
      { title: "FM Dashboard", url: "/contract-dashboard", module: "contracts" },
      { title: "FM Contracts / Contract Workspace", url: "/contracts", module: "contracts" },
      { title: "Service Categories", url: "/contract-service-categories", module: "contracts" },
      { title: "Contract Line Items", url: "/contract-line-items", module: "contracts" },
      { title: "FM Asset Register", url: "/contract-assets", module: "contracts" },
      { title: "PPM Planner", url: "/contract-ppm", module: "contracts" },
      { title: "FM Work Orders / SLA Work Orders", url: "/work-orders", module: "service" },
      { title: "SLA & KPI Tracker", url: "/contract-sla", module: "contracts" },
      { title: "Manpower Planning", url: "/contract-manpower", module: "contracts" },
